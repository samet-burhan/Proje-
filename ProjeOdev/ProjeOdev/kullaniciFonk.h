...
void Kullanicilar::kayit(string ad, string soyad, string kullancýAdi, string password, string Email, string adres, string   Tc_KimlikNo, string   telefon) {

	this->ad = ad;
	this->soyad = soyad;
	this->kullancýAdi = kullancýAdi;
